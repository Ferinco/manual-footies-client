...
export default function RightSide() {
  return (
    <div className="container md:w-1/3 xl:w-1/2 h-auto bg-gradient-to-tl from-orange-500 via-15% via-white/25 to-transparent overflow-hidden flex xl:justify-center items-center mt-7 md:mt-0">
